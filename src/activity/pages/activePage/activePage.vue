...
export default {
    ...
    onLoad(option) {
        ...
        this.pageUrl = this.baseUrl + 'activePage.html'+'?storeId='+this.storeId+'&isiphoneBt='+this.isiphoneBt+'&shareDistributorId='+this.shareDistributorId+(_token ? '&_token=' + _token : '')+'&v='+new Date().getTime();
    },
    message(event){
