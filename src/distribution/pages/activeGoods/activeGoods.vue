...
export default {
    ...
    onLoad(option) {
        ...
        this.storeId =option.storeId || this.getStor('_storeId_') || this.getStor('_defaultStoreId_');
        this.consignorId = option.consignorId || this.getStor('_defaultConsignorId_');
        this.pageUrl = this.baseUrl + 'activeGoods.html?shareDistributorId='+111+'&activitysaleId='+222+'&consignorId='+this.consignorId+'&storeId='+this.storeId+(_token ? '&_token=' + _token : '');
    },
    methods:{
        getManInfo: function () {
        //获取分销员信息
    ...
    nowShareUrl = this.nowShareUrl+'?storeId='+this.storeId +'&shareDistributorId='+111+'&consignorId='+ this.consignorId+'&activitysaleId='+222;
