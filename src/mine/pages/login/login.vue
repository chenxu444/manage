              ...
              (res) => {
                ...
                this.doRequest(
                  ...
                  if (data) {
                    ...
                    if (this.isBack == 'index') {
                      setTimeout(() => {
                        this.resetUrl('index');
                      });
                    } else if (this.isBack == 'activePage') {
                      setTimeout(() => {
                        this.replaceUrl('activePage','activity');
                      });
                    } else if (this.isBack == 'activeGoods') {
                      setTimeout(() => {
                        this.replaceUrl('activeGoods','distribution');
                      });
                    }
                    else if(this.isBack == true || this.isBack == 'true') {
                      setTimeout(() => {
                        uni.navigateBack({
                          delta: 1,
                        });
