<template>
	<view v-if="show" class="uni-noticebar" :style="{ backgroundColor: backgroundColor }" @click="onClick">
		...
		<view v-if="showClose === true || showClose === 'true'" class="uni-noticebar-close" @click="close">
			<view class="iconfont icon-closeBtn" :style="color ? 'color: ' + color : ''"></view>
		</view>
		<view v-if="showIcon === true || showIcon === 'true'" class="uni-noticebar-icon">
			<view class="iconfont icon-sound" :style="'font-size: 14px;' + (color ? 'color: ' + color : '')"></view>
		</view>
		<!-- #endif -->
		<!-- #ifndef MP-ALIPAY -->
		<view v-if="showClose === true || showClose === 'true'" class="uni-noticebar-closeiconfont icon-closeBtn" :style="color ? 'color: ' + color : ''" @click="close"></view>
		<view v-if="showIcon === true || showIcon === 'true'" class="uni-noticebar-icon iconfont icon-sound" :style="'font-size: 14px;' + (color ? 'color: ' + color : '')"></view>
		<!-- #endif -->
		...
		<view v-if="showGetMore === true || showGetMore === 'true'" class="uni-noticebar__more" @click="clickMore">
			...
			<view class="iconfont icon-Rarrow" :style="color ? 'color: ' + moreColor : ''"></view>
		</view>
	</view>
</template>
