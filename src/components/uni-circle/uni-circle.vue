<template>
	<view>
		<view :style="cBox">
			<span style="line-height: 1.2;text-align: center;" v-if="!slot">
				<view style="font-size: 13px;">{{animationPercent}}%</view>
				<view style="font-size: 12px;">已领</view>
			</span>
			...
			cBox(){
				...
				var style=
					`	
						...
						height:${circleWidth*2+size-10}px !important;
						width:${circleWidth*2+size-10}px !important;
