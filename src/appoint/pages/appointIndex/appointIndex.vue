<template>
  <div class="appointIndex" >
      <!-- #ifndef MP-WEIXIN -->
        <uni-nav-hfbar fixed status-bar left-icon="back" title="预约首页"></uni-nav-hfbar>
        <!-- #endif -->
...
export default {
    ...
    onLoad(options){
        ...
        this.consignorId = options.consignorId ? options.consignorId : this.getStor('_defaultConsignorId_')
        this.getList()
    }
}
</script>
