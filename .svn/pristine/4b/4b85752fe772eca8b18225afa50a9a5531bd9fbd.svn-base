<template xlang="wxml" minapp="mpvue">
	<view class="uni-barcode">
		<!-- #ifndef MP-ALIPAY -->
		<canvas class="uni-barcode-canvas" :canvas-id="cid" :style="{width:canvasWidth+'px',height:canvasHeight+'px'}" />
		<!-- #endif -->
		<!-- #ifdef MP-ALIPAY -->
		<canvas :id="cid" :width="canvasWidth" :height="canvasHeight" class="uni-barcode-canvas" />
		<!-- #endif -->
		<image class="barCodeImg" v-show="show" :src="result" :style="{width:canvasWidth+'px',height:canvasHeight+'px'}" />
	</view>
</template>
