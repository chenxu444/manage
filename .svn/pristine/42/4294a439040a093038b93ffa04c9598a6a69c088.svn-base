                                ...
                                <view class="normal-list">
                                    <view class="normal-item" v-for="(sell,index) in sellerItems">
                                        ...
                                        <view class="normalItem-zd uni-flex" v-if="sell.orderPromotion != null">
                                            ...
                                            <view class="zd-add" v-if="sell.orderPromotion && !sell.orderPromotion.fixedFlag" @click="goList(sell.orderPromotion,sell.storeId)">去凑单 ></view>
                                        </view>
                                        <!-- 整单 -- end -->
                                        <!-- 活动商品 -- start -->
                                        <view class="act normalItem-list" v-for="(act,aindex) in sell.skuCartDiscountGroupItemDTOS" :style="aindex == (sell.skuCartDiscountGroupItemDTOS.length -1) && ((sell.skuItems == null || sell.skuItems.length == 0) && (sell.skuCartGroupItemDTOS == null || sell.skuCartGroupItemDTOS.length == 0)) ? 'border-bottom:none;' : ''">
                                            ...
                                            <view class="normalItem-list-mj uni-flex">
                                                ...
                                                <view class="mj-add" v-if="act.itemDiscountOfferPromotionDTO && !act.itemDiscountOfferPromotionDTO.fixedFlag" @click="goList(act.itemDiscountOfferPromotionDTO,sell.storeId)">去凑单 ></view>
                                            </view>
                                            <!-- 满额 -- end -->
                                            <uni-swipe-action>
                                                <!-- 单品 -- start -->
                                                        ...
                                                        <view class="normalItem-item-right uni-flex-1">
                                                            ...
                                                            <view class="normalItem-item-goods uni-flex">
                                                                <view class="goods-img">
                                                                    <image class="img" mode="aspectFit" :lazy-load="true" :src="changeImgSize(goods.defaultImg,'90')" @click="goDetails(goods,sell.storeId)"></image>
                                                                </view>
                                                            ...
                                                            <view class="normalItem-item-list">
                                                                <view class="normalItem-item-goods">
                                                                    <view class="normalItem-group-goods uni-flex" v-for="groupGoods in group.skuCartItemDTO">
                                                                        <view class="goods-img">
                                                                            <image class="img" mode="aspectFit" :lazy-load="true" :src="changeImgSize(groupGoods.defaultImg,'90')" @click="goDetails(groupGoods,sell.storeId)"></image>
                                                                        </view>
                                                                        <view class="goods-info uni-flex-1">
                                                                            <view class="goods-name">
                                            ...
                                            <!-- 满赠赠品 -- start -->
                                            <view class="normalItem-zp" v-if="act.itemDiscountOfferPromotionDTO != null && act.itemDiscountOfferPromotionDTO.fixedFlag == true && act.itemDiscountOfferPromotionDTO.promotionContentDTOS != null && act.itemDiscountOfferPromotionDTO.promotionContentDTOS.length > 0">
                                        ...
                                        <!-- 普通商品 -- end -->
                                        <!-- 整单赠品 -- start -->
                                        <view class="normalItem-zp" v-if="sell.orderPromotion != null && sell.orderPromotion.fixedFlag == true && sell.orderPromotion.promotionContentDTOS != null && sell.orderPromotion.promotionContentDTOS.length > 0">
                                            <view class="normalItem-zp-list">
                            ...
                            <view class="youLike">
                                ...
                                <view class="yl-list clearfix">
                                    <view class="yl-item fl bg_white" v-for="(youLike,index) in youLikeList"  @click="replaceUrl('detail', '', 'skuSalNo=' + youLike.skuSalNo + '&storeId=' + youLike.storeDTO.storeId + '&consignorId=' + youLike.consignorId)">
                                        <view class="yl-img">
                                            <image class="img" mode="aspectFit" :lazy-load="true" :src="changeImgSize(youLike.imagePath,'90')"></image>
                                        </view>
                                        <view class="yl-info">
...
export default {
    ...
    methods: {
        ...
        changeImgSize: function(value, num) { // 原图转成其他尺寸图
			if (!value) {
