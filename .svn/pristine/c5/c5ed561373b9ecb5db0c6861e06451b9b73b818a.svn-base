<template>
  <view class="share" style="width: 100%; height: 100%">
    ...
    <view
      ...
      @click="closePupu"
    >
      <img src="../../static/image/user/share_help.png" style="width: 100%; height: 100%">
    </view>
    <!-- #endif -->
    <view class="topimg">
    ...
    <view class="share_item">
      ...
      <view class="uni-flex btn_wrap">
        ...
        <view class="bottom_btn bg_common" @click="getInvateCode(true)"
          >刷新邀请码</view
        >
      </view>
    </view>
    ...
    <uni-popup ref="sharePop" :animation="true">
      <view class="dia-wrap bg_white">
        ...
        <view class="dia-des tc">确定邀请推广员？</view>
...
export default {
  ...
  onShareAppMessage(res) {
    ...
    return {
      title: "推广员邀请",
      content: this.idName + "想要邀请您成为推广员",
    ...
    getInvateCode(refresh) {
      ...
      this.doRequest(
        ...
        if (data.success) {
          ...
          this.canvasAttr.posterCodeUrl = this.wechat_base + "/wechatcenter/qrcode/v1/" + this.getStor("_appid_") + "/create?scene=" + encodeURIComponent("code=" + this.code) + "&width=280&page=distribution/pages/becomeGuide/becomeGuide";
          this.$nextTick(() => {
            this.getCodeUrl();
          });
        } else {
